class Solution {
    /**
     * Approach II : Using Segment Trees Approach
     *
     * TC: O(N x log(N))
     * SC: O(4 x N) ~ O(N)
     *
     * Accepted (740 / 740 testcases passed)
     */
     ...
     * SC: O(1)
     *
     * Time Limit Exceeded (737 / 740 testcases passed)
     */
    public int numOfUnplacedFruitsBruteForce(int[] fruits, int[] baskets) {
        int n = fruits.length;
        int countUnplaced = 0;
